class eventsManager {
    ...
    getMouseDelta() {
        //let mouseDeltaX = this.mouse.x - (getCurrentCanvas().getBoundingClientRect().left) - (getGameManager().player.posX + Math.floor(getGameManager().player.sizeX / 2.0) - getMapManager().camera.x);
        //let mouseDeltaY = this.mouse.y - (getCurrentCanvas().getBoundingClientRect().top) - (getGameManager().player.posY + Math.floor(getGameManager().player.sizeY / 2.0) - getMapManager().camera.y);
